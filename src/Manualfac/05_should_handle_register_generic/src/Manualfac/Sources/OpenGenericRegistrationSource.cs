...
namespace Manualfac.Sources
{
    class OpenGenericRegistrationSource : IRegistrationSource
    {
        ...
        public ComponentRegistration RegistrationFor(Service service)
        {
            ...
            Type genericType = implementorType.MakeGenericType(serviceType.GenericTypeArguments);
            return new ComponentRegistration(service, new ReflectiveActivator(genericType));
